...
return [
    ...
    'different' => "参数 '{parameter-name}' 和参数 '{bind-value_1}' 的值相同",
    'same' => "参数 '{parameter-name}' 和参数 '{bind-value_1}' 的值不同",
    ...
    'file_max' => "文件大小最大为 {bind-value_1}MB",
    'file_min' => "文件大小最小为 {bind-value_1}MB",
    'file_size_between' => "文件大小只能在 {bind-value_1}MB 和 {bind-value_2}MB 之间",
];
